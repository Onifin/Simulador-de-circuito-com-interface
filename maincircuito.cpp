...
{
  QString fileName = QFileDialog::getOpenFileName(this, "Arquivo de circuito", QString(), "Circuitos (*.txt);;Todos (*.*)");
  std::string fileNameStr = fileName.toLocal8Bit().constData();
...
void MainCircuito::on_actionSalvar_triggered()
{
  ...
  QString fileName = QFileDialog::getSaveFileName(this, "Arquivo de circuito", QString(), "Circuitos (*.txt);;Todos (*.*)");
  std::string fileNameStr = fileName.toLocal8Bit().constData();
